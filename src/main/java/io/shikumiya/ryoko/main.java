...
import io.shikumiya.ryoko.listeners.OptionalListener;
import io.shikumiya.ryoko.skills.DoubleJump;
...
public final class main extends JavaPlugin {
    ...
    public void onEnable() {
        ...
        getServer().getPluginManager().registerEvents(new OptionalListener(this), this);
    }
